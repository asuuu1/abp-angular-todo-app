...
public class MyAbpProjectDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public MyAbpProjectDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
