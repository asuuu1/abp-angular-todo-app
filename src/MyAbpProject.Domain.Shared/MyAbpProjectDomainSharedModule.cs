...
public class MyAbpProjectDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        MyAbpProjectGlobalFeatureConfigurator.Configure();
        MyAbpProjectModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<MyAbpProjectDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<MyAbpProjectResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/MyAbpProject");

            options.DefaultResourceType = typeof(MyAbpProjectResource);
        ...
        {
            options.MapCodeNamespace("MyAbpProject", typeof(MyAbpProjectResource));
        });
    }
}
